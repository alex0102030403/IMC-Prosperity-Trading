    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        for product in state.order_depths.keys():
            ...
            if product == 'PEARLS':
                ...
                product_price = pd.DataFrame(pearls_q)
                ema = product_price.ewm(com=0.😎.mean()
                print("ema is: ", ema)

                print("size of q is: ", len(pearls_q))
            ...
            if product == 'BANANAS':
                ...
                product_price = pd.DataFrame(bananas_q)
                ema = product_price.ewm(com=0.😎.mean()
                print("ema is: ", ema)

                print("size of q is: ", len(bananas_q))
                # Define a fair value for the PEARLS.
                # Note that this value of 1 is just a dummy value, you should likely change it!
                acceptable_price = average
                print("average is: ", acceptable_price)
